...
class PlazaDeckSystemImport extends AbstractSystemImport
{
    /**
    ...
    {
        $this->signature = 'soprema:import:plazadeckSystem {file : CSV containing the systems}';

        $this->description = 'Import and create plaza deck systems';
        ...
        $this->field_array_key_match = [
            0  => 'system_name',
            4  => 'system_' . self::PLAZA_DECK_SYSTEM . '_membrane_type',
            5  => 'system_bridging',
            18 => 'system_' . self::PLAZA_DECK_SYSTEM . '_high_performance',
            20 => 'system_guaranty',
        ];
    }
    ...
    {
        $this->info('Import plaza deck system');
