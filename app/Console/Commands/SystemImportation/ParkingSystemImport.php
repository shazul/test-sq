...
class ParkingSystemImport extends AbstractSystemImport
{
    /**
    ...
    {
        $this->signature = 'soprema:import:parkingSystem {file : CSV containing the systems}';

        $this->description = 'Import and create parking systems';
        ...
        $this->field_array_key_match = [
            0  => 'system_name',
            5  => 'system_' . self::PARKING_SYSTEM . '_membrane_type',
            4  => 'system_' . self::PARKING_SYSTEM . '_family',
            6  => 'system_installation_method',
            7  => 'system_bridging',
            18 => 'system_' . self::PARKING_SYSTEM . '_high_performance',
            20 => 'system_guaranty',
        ];
    }
    ...
    {
        $this->info('Import parking system');
