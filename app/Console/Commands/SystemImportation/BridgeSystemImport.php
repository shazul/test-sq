...
class BridgeSystemImport extends AbstractSystemImport
{
    /**
    ...
    {
        $this->signature = 'soprema:import:bridgeSystem {file : CSV containing the systems}';

        $this->description = 'Import and create bridge systems';
        ...
        $this->field_array_key_match = [
            0  => 'system_name',
            4  => 'system_' . self::BRIDGE_SYSTEM . '_membrane_type',
            5  => 'system_bridging',
            18 => 'system_' . self::BRIDGE_SYSTEM . '_high_performance',
            20 => 'system_guaranty',
        ];
    }
    ...
    {
        $this->info('Import bridge system');
